...
describe("RingBuffer", () => {
  ...
  const BUFFER_SIZE = 4096; // 4KB for testing
  ...
  it("should handle bidirectional communication", () => {
    ...
    const workerBuffer = new RingBuffer(BUFFER_SIZE, mainBuffer.getBuffer(), BufferDirection.WORKER_TO_MAIN);
    ...
    const writeResult2 = workerBuffer.write(MessageType.MAIN_THREAD_INSTRUCTION, "worker-to-main", "response");
