...
import { zoraSepolia, goerli, zora, baseSepolia } from "wagmi/chains";
...
export const ZenCodeSidebar: React.FC<{ hide: () => void }> = ({ hide }) => {
  ...
  const inner = React.useMemo(() => {
    ...
    console.log("miniting=%s", minting);
    console.log(
      "data=",
      compressedDSP,
      compressedVisuals,
        ...
        {switchNetwork && chain && (
          <div className="flex mb-1 gap-2">
            <div
              ...
              className={
                "cursor-pointer " +
                (chain.id === baseSepolia.id ? "border-bottom text-white " : " text-zinc-400")
              }
            >
              base sepolia
            </div>
