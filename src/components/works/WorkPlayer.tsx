...
const WorkPlayer: React.FC<{ close: () => void; work: WorkOption }> = ({ work, close }) => {
  ...
  return (
    <div className="flex flex-col w-full min-h-screen h-full max-h-screen bg-zinc-950">
      {!fullscreen && !isMobile && (
        <div className="fixed bottom-8 left-40 text-sm flex">
            ...
            <Tooltip.Root>
              <Tooltip.Trigger asChild>
                <div
                  ...
                  className={
                    (!video ? "opacity-40 " : "") +
                    "flex flex-row mr-5 cursor-pointer bg-zinc-900 rounded-xl p-2"
                  }
                >
                  <VideoIcon
                    className={
              ...
              <Tooltip.Portal>
                <Tooltip.Content
                  ...
                  side={"top"}
                  className="pointer-events-none  bg-zinc-900 px-2 py-1 text-white rounded-lg w-64 "
                  sideOffset={5}
                >
            ...
            <Tooltip.Root>
              ...
              <Tooltip.Portal>
                <Tooltip.Content
                  style={{ zIndex: 100000000000, fontSize: 12 }}
                  side={"top"}
                  className="pointer-events-none  w-64 bg-zinc-900 px-2 py-1 text-white rounded-lg "
                  sideOffset={5}
                >
                  <div>
      ...
      <div className="absolute top-5 right-5">
        {account && account.address && !fullscreen && (
        ...
        {showVideo && video !== null && video !== "" ? (
          <video
            ...
            style={{
              ...
              width: fullscreen ? "100vw" : isMobile ? "90vw" : "106vh",
              height: fullscreen ? "100vh" : isMobile ? "60vh" : "80vh",
            }}
            className={
              (fullscreen ? "" : "border-zinc-800 rounded-md border ") +
      ...
      {showInfo && !isClientMobile && !fullscreen && parameters && (
        <Tooltip.Provider disableHoverableContent={true} delayDuration={200}>
          <Tooltip.Root>
            <Tooltip.Trigger asChild>
      ...
      <div
        ...
        className={
          (isMobile
            ...
            : fullscreen
              ? "right-10 bottom-8 "
              : "left-0 right-0 mx-auto bottom-8 ") +
          (opened
            ? _totalSupply > 20
              ? "h-64 pr-5"
              : "h-36 pr-5"
            : showInfo
              ? "h-44 pr-5 "
              : "h-10") +
          " fixed  bg-zinc-900 pl-10 flex text-xs transition-all duration-300 ease-in-out "
        }
      >
        {opened ? (
          ...
          <div className="flex my-auto pr-5 flex-col">
            ...
            <div className="flex mt-2">
              <a
                ...
                href={`https://explorer.zora.energy/address/${work.dropAddress}`}
              >
                contract
              </a>
              <ArrowTopRightIcon className="w-3 h-3 ml-2" />
              <a
                className="ml-5 text-zinc-300 underline"
                href={`https://zora.co/collect/zora:${work.dropAddress}/${activeAnimation}`}
              >
                zora
              </a>
              <ArrowTopRightIcon className="w-3 h-3 ml-2" />
              ...
              <CopyIcon
                ...
                className={
                  (copied ? "text-teal-300 " : "text-zinc-300 ") +
                  "transition-colors w-4 h-4 ml-2 cursor-pointer"
                }
              />
            </div>
          </div>
          ...
          <>
            <div className="w-48 my-auto text-base flex">
              ...
              <InfoCircledIcon
                ...
                className="w-4 h-4 ml-4 my-auto cursor-pointer  transition-all hover:stroke-zinc-100"
              />
            </div>
            {showInfo && (
              <div
            ...
            <div
              ...
              className={
                (opened ? "bg-zinc-700 " : "") +
                " ml-10 w-32 my-auto h-full flex text-center cursor-pointer relative hover:bg-zinc-700 transition-colors "
              }
            >
              {opened && (
                <div
                ...
                <Tooltip.Root>
                  ...
                  <Tooltip.Portal>
                    <Tooltip.Content
                      ...
                      side={"top"}
                      className="pointer-events-none  mb-4 bg-zinc-100 px-2 py-1 text-black rounded-lg "
                      sideOffset={5}
                    >
      ...
      {!fullscreen && (
        <div
          className={
            isMobile
              ? (totalPrice
                  ? "right-0 left-0 w-64 bottom-0 top-0 m-auto "
                  : wrongNetwork
      ...
      {isMobile && video && (
        <div className="bottom-5 w-96 text-xs italic text-zinc-300 fixed mx-auto left-0 w-full text-center right-0">
