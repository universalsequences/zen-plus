...
import { FilterGraphValue, FilterType, FilterParams } from "../../lib/nodes/definitions/core/filtergraph";
...
const FilterGraphSVG: React.FC<FilterGraphProps> = ({ objectNode }) => {
  ...
  return (
    ...
    >
      {/* Background */}
      <rect x="0" y="0" width={width} height={height} fill={objectNode.attributes["backgroundColor"] || "#303030"} />
