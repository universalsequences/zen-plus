...
async function getHTML(contractAddress: string, tokenId: string, chainId: number, version: number): Promise<any | null> {
    ...
    try {
        ...
        return { video: metadataJSON.video, audio: metadataJSON.audio };
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
    ...
    try {
        let json = await getHTML(contractAddress, tokenId, _chainId, _version);
