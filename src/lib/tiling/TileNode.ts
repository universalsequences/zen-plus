...
export class TileNode implements Tile {
    ...
    constructor(patch: Patch | null, parent: TileNode | null = null, position = { rowStart: 1, rowEnd: 2, colStart: 1, colEnd: 2 }) {
        this.id = uuid();
        this.parent = parent;
        this.children = [];
    ...
    split(direction: Direction, newPatch: Patch): void {
        ...
        if (direction === 'vertical') {
            ...
            this.children = [
                ...
                new TileNode(newPatch, this, { ...this.position, rowStart: midRow + 1, rowEnd: midRow + 1 })
            ];
        } else {
            ...
            this.children = [
                ...
                new TileNode(newPatch, this, { ...this.position, colStart: midCol + 1, colEnd: midCol + 1 })
            ];
        }
